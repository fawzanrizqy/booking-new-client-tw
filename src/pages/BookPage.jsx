...
export const BookPage = () => {
  ...
  return (
    <div className="container mx-auto max-w-7xl px-6 lg:px-8">
      ...
      {/* heading */}
      {/* menu */}
      <div className="bg-white shadow-lg ring-1 ring-gray-900/5 sm:rounded-xl rounded-xl md:col-span-2 p-10">
                ...
                {ruang &&
                  ruang.map((r, index) => (
                    <option key={index} value={r.id}>
                      {r.nama_ruang} - ({r.kapasitas} Persons)
                    </option>
                  ))}
              </select>
            </div>
        ...
        <div className="flex justify-end gap-4">
          <NavLink to={"/"}>
            <button
              type="button"
              className="inline-flex items-center rounded-md bg-gray-500 px-3.5 py-2.5 text-sm font-semibold shadow-sm hover:bg-gray-600 text-white"
            >
              Cancel
            </button>
          </NavLink>
